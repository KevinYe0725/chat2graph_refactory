...
class KnowledgeBaseManager:
    ...
    def get_global_knowledge_base(self) -> Tuple[Dict[str, Any], str]:
        """Get global knowledge base.

        Returns:
            Tuple[Dict[str, Any], str]: A tuple containing global knowledge base details and success message
        """
        global_knowledge_base, _ = self._knowledge_base_service.get_all_knowledge_bases()
        data = self._knowledge_base_view.serialize_knowledge_base(global_knowledge_base)
        return data, "Global knowledge base fetched successfully"
